...
module Spotify
  class PlaylistSyncSetup
    ...
    attr_reader :playlist_session, :adapter
    ...
    def persist_first_page(first_page_items, version:, total_pages:)
      ActiveRecord::Base.transaction do
        update_playlist_session(first_page_items, version: version, total_pages: total_pages)
        process_first_page_items(first_page_items, version: version) if first_page_items.any?
      end
    end
    ...
    def update_playlist_session(first_page_items, version:, total_pages:)
    ...
    def process_first_page_items(first_page_items, version:)
    ...
    def calculate_remaining_pages(first_page_items, total_pages:)
