...
ActiveRecord::Schema[8.1].define(version: 2026_08_13_141602) do
  ...
  create_table "genres", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_genres_on_name_trgm", opclass: :gin_trgm_ops, using: :gin
  end
  ...
  create_table "playlist_version_tracks", force: :cascade do |t|
    ...
    t.index ["playlist_version_id", "track_id", "added_at"], name: "idx_playlist_version_tracks_added_at"
  ...
  create_table "push_sessions", force: :cascade do |t|
    t.datetime "add_phase_started_at"
    t.bigint "baseline_version_id"
  ...
  create_table "sync_session_playlists", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["baseline_version_id"], name: "index_sync_session_playlists_on_baseline_version_id"
